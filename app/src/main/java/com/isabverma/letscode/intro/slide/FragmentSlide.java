...
import com.isabverma.letscode.intro.app.ButtonCtaFragment;
import com.isabverma.letscode.intro.app.SlideFragment;
import com.isabverma.letscode.intro.view.parallax.ParallaxFragment;
...
public class FragmentSlide implements Slide, RestorableSlide, ButtonCtaSlide {
    ...
    public static class FragmentSlideFragment extends ParallaxFragment {
        ...
        private static final String ARGUMENT_THEME_RES =
                "com.isabverma.letscode.intro.SimpleFragment.ARGUMENT_THEME_RES";
